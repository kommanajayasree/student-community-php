...
<head>
    ...
    <style>
        ...
        .like-button,.comment-button{
            padding:1px;background-color:rgb(255,255,255);
...
<body>
    <div class="top">
        ...
        <img style="margin: 10px;margin-left: 250px;margin-top: 15px;"  src="img/msg1.png" width="40px" height="35px">
                    ...
                    <table style="margin: 0 auto;">
                        <tr>
                            <td id="post" id="post1">
                                ...
                                <button style="font-family: 'Poppins';" class="like-button" data-post-id="1">Like</button>
                                    <!-- Display like count -->
                                    ...
                                    <p id="like1">count</p> -->
                                    <button style="font-family: 'Poppins';" class="comment-button" data-post-id="1">Comment</button>
                    ...
                    <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
                        ...
                        <tr>
                            <td id="post" id="post1">
                                ...
                                <button style="font-family: 'Poppins';" class="like-button" data-post-id="2">Like</button>
                                    <!-- Display like count -->
                                    <span id="like-count-1"><?php echo getLikeCount(2); ?></span>
                                    <!-- <img class="likeIcon" data-post-id="1" src="img/likeC.jpg" width="27px" height="27px">
                                   
                                    <p id="like1">count</p> -->
                                    <button style="font-family: 'Poppins';" class="comment-button" data-post-id="2">Comment</button>
                                    <!-- Display comment count -->
                                    <span id="comment-count-1"><?php echo getCommentCount(2); ?></span>
